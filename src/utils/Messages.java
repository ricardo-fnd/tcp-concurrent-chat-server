...
public class Messages {
    ...
    public static final String WHISPER_USAGE = "SERVER: Usage: /whisper <username> <message>";
    public static final String REPLY_ERROR = "SERVER: Can't reply if no one whispered to you!";
